...
const WishlistEditForm: React.FC<WishlistFormProps> = ({ items: initialItems, name:name, id:id, onSubmit, onClickBack }) => {
  ...
  return (
    <>
      <div className="container p-4 rounded profile-container">
        <UpperPanel name="Edit wishlist" onClickBack={() => onClickBack()}/>
        ...
        <form onSubmit={handleSubmit} className="edit-wishlist-form">
          ...
          <LoadingSpinner
            message="This may take a few seconds, we are fetching the item data from eshop..."
