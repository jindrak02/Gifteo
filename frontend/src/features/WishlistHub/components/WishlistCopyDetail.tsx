        ...
        return (
            <>
                <div className="d-flex justify-content-end">
                    <button className="btn btn-secondary" onClick={() => setIsAddingPerson(false)}>
                        Close
                    </button>
                </div>

                <AddPerson wishlistCopyId={id}/>
            </>
        );
    }
        ...
        <>
            <div>
                <div className="flex justify-between">
                    ...
                    <button className="btn btn-secondary" onClick={() => console.log('TODO: show info about wishlist participants')}>
                    ...
                    <div key={index} className= {item.checkedOffBy != null ? "wishlist-item wishlist-item-checked" : "wishlist-item"}>
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                id={`checkbox-${item.id}`} 
                            />
                            {item.checkedOffBy != null ? <img className="check-off-img rounded" src={item.checkedOffByPhoto || ''} alt="img" /> : null}
                        </div>
                    </div>
                ))}
            </div>
