                        ...
                        <li key={invitation.id} className="invitation-item">
                            <div className="user-thumbnail">
                                ...
                                <div className="invitation-actions flex space-x-2">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="black" className="bi bi-check icon-button" viewBox="0 0 16 16">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="black" className="bi bi-x icon-button" viewBox="0 0 16 16">
